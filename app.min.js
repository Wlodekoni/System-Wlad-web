...
Ext.define('Traccar.store.MapTypes',{extend:Ext.data.Store,fields:['key','name'],data:[{key:'carto',name:Strings.mapCarto},{key:'osm',name:Strings.mapOsm},{key:'bingRoad',name:Strings.mapBingRoad},{key:'bingAerial',name:Strings.mapBingAerial},{key:'bingHybrid',name:Strings.mapBingHybrid},{key:'autoNavi',name:Strings.mapAutoNavi},{key:'yandexMap',name:Strings.mapYandexMap},{key:'yandexSat',name:Strings.mapYandexSat},{key:'wikimedia',name:Strings.mapWikimedia},{key:'custom',name:Strings.mapCustom},
...
new ol.layer.Tile({title:Strings.mapAutoNavi,type:'base',visible:'autoNavi'===type||'baidu'===type,source:new ol.source.OSM({url:'https://webrd0{1-4}.is.autonavi.com/appmaptile?lang\x3dzh_cn\x26size\x3d1\x26scale\x3d1\x26style\x3d8\x26x\x3d{x}\x26y\x3d{y}\x26z\x3d{z}'})}),new ol.layer.Tile({title:Strings.mapYandexMap,type:'base',visible:'yandexMap'===type,source:new ol.source.XYZ({url:'https://vec0{1-4}.maps.yandex.net/tiles?l\x3dmap\x26x\x3d{x}\x26y\x3d{y}\x26z\x3d{z}',projection:'EPSG:3395',attributions:'\x26copy; \x3ca href\x3d"https://yandex.com/maps/"\x3eYandex\x3c/a\x3e'})}),
new ol.layer.Tile({title:Strings.mapYandexSat,type:'base',visible:'yandexSat'===type,source:new ol.source.XYZ({url:'https://sat0{1-4}.maps.yandex.net/tiles?l\x3dsat\x26x\x3d{x}\x26y\x3d{y}\x26z\x3d{z}',projection:'EPSG:3395',attributions:'\x26copy; \x3ca href\x3d"https://yandex.com/maps/"\x3eYandex\x3c/a\x3e'})}),new ol.layer.Tile({title:Strings.mapWikimedia,type:'base',visible:'wikimedia'===type,source:new ol.source.OSM({url:'https://maps.wikimedia.org/osm-intl/{z}/{x}/{y}.png'})}),new ol.layer.Tile({title:Strings.mapOsm,
type:'base',visible:'osm'===type||!type,source:new ol.source.OSM({})})]});type=Traccar.app.getPreference('latitude',Traccar.Style.mapDefaultLat);bingKey=Traccar.app.getPreference('longitude',Traccar.Style.mapDefaultLon);var zoom=Traccar.app.getPreference('zoom',Traccar.Style.mapDefaultZoom);var maxZoom=Traccar.app.getAttributePreference('web.maxZoom',Traccar.Style.mapMaxZoom);this.mapView=new ol.View({center:ol.proj.fromLonLat([bingKey,type]),zoom:zoom,maxZoom:maxZoom});this.map=new ol.Map({target:this.body.dom.id,
